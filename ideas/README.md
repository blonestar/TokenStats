...
CI, tag-driven draft-release, and native macOS arm64 validation workflows have
verified GitHub runs, including the published `v0.1.0` Linux and macOS release;
ideas remain non-authoritative until
recorded in `/docs`.
